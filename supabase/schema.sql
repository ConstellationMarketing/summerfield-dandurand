...
SELECT 'Practice Page Template', 'practice',
  '{"hero":{"sectionLabel":"Practice Area","tagline":"Focused Legal Representation","description":"<p>Introduce this practice area and explain how Custom Law can help.</p>","backgroundImage":"","backgroundImageAlt":""},"socialProof":{"mode":"awards","testimonials":[],"awards":{"logos":[]}},"contentSections":[{"body":"<h2>Practice Area Overview</h2><p>Add accurate, page-specific content here.</p>","image":"","imageAlt":"","imagePosition":"right","showCTAs":false,"subPracticesHeading":"Related Services","subPractices":[]}],"expectations":{"enabled":true,"sectionLabel":"Prepared for What Comes Next","heading":"What to Expect from Custom Law","description":"<p>Explain the client experience and how the firm approaches this practice area.</p>","attorneys":[],"features":[{"number":"01","title":"Individual Attention","description":"<p>Describe the page-specific benefit.</p>"},{"number":"02","title":"Clear Communication","description":"<p>Describe the page-specific benefit.</p>"},{"number":"03","title":"Prepared Advocacy","description":"<p>Describe the page-specific benefit.</p>"}],"stats":[]},"reviews":{"enabled":true,"sectionLabel":"Client Reviews","heading":"What Our Clients Say","reviewBadgeText":"Rated 5.0 on Google Reviews","backgroundImage":"","backgroundImageAlt":"","items":[]},"faq":{"enabled":false,"heading":"","description":"","items":[]},"headingTags":{}}'::jsonb,
