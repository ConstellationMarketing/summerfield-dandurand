        ...
        <div className="lg:w-[65.667%]">
          <div className="mb-[40px]">
            <div className="relative">
              <p className="font-playfair text-[clamp(2rem,5vw,68.8px)] font-light leading-[1.2] text-black text-left">
                {phoneLabel}
              </p>
            </div>
          </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="font-outfit text-[18px] leading-[18px] text-white pb-[10px] font-normal transition-colors duration-300">
                  {phoneLabel}
                </p>
