...
export default function ContactPage() {
  const { content, meta, title, publishedAt, updatedAt, isLoading } =
    useContactContent();
  ...
  const contactMethods = content.contactMethods.methods.map((method) => ({
    ...
    title: method.title,
    detail:
      method.detail || (method.title === "Phone" ? phoneDisplay : ""),
  ...
  const hasSidebar =
    ...
    Boolean(phoneNumber) ||
    Boolean(content.cta.secondaryButton.label);
  const processGrid =
  ...
  return (
    <Layout>
      ...
      <section className="bg-brand-dark pt-[30px] md:pt-[54px] pb-[30px] md:pb-[54px]">
      ...
      {contactMethods.length > 0 && (
        <section className="bg-white py-[40px] md:py-[60px]">
          <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%] lg:w-[85%]">
            {content.contactMethods.heading && (
              <h2 className="font-playfair text-[32px] md:text-[48px] leading-tight text-brand-dark text-center mb-[30px] md:mb-[45px]">
                {content.contactMethods.heading}
              </h2>
            )}
      ...
      <section className="bg-brand-dark py-[40px] md:py-[60px]">
        <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%] lg:w-[85%]">
          <div
            className={`grid grid-cols-1 ${hasSidebar ? "lg:grid-cols-2" : ""} gap-8 lg:gap-[8%]`}
          >
            <div>
            ...
            {hasSidebar && (
              <aside className="space-y-[30px] md:space-y-[40px]">
                {officeHours.length > 0 && (
                  <div className="bg-brand-card border border-brand-border p-[30px] md:p-[40px]">
                    ...
                    {content.officeHours.note && (
                      <RichText
                        ...
                        className="font-outfit text-[14px] md:text-[16px] text-white/70 leading-[22px] md:leading-[24px] mt-[25px] pt-[25px] border-t border-brand-border/50"
                      />
                    )}
                  </div>
                )}
      ...
      {processSteps.length > 0 && (
        <section className="bg-white py-[40px] md:py-[60px]">
          <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%] lg:w-[80%]">
            ...
            <div className={`grid ${processGrid} gap-6 md:gap-8`}>
      ...
      {(content.visitOffice.heading || mapEmbedUrl) && (
        <section className="bg-brand-dark py-[40px] md:py-[60px]">
          <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%]">
            {(content.visitOffice.heading || content.visitOffice.subtext) && (
